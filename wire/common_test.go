...
var mainNetGenesisHash = bitcoin.Hash32([bitcoin.Hash32Size]byte{ // Make go vet happy.
...
var mainNetGenesisMerkleRoot = bitcoin.Hash32([bitcoin.Hash32Size]byte{ // Make go vet happy.
