...
func Test_TemplateEncoding(t *testing.T) {
	tests := []struct {
		...
		{
			name: "MultiPKH_1_2",
			text: `OP_0 OP_TOALTSTACK OP_IF OP_DUP OP_HASH160 OP_PUBKEYHASH OP_EQUALVERIFY
				...
				OP_TOALTSTACK OP_ENDIF OP_1 OP_FROMALTSTACK OP_LESSTHANOREQUAL`,
			hex: "006b6376a9b988ad6c8b6b686376a9b988ad6c8b6b68516ca1",
		},
	}
